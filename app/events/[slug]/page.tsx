    ...
    <main className="min-h-screen bg-white text-neutral-900 font-sans overflow-x-clip">
                ...
                <div className="p-5 sm:p-8 space-y-4 sm:space-y-6">
                  ...
                  <div className="flex items-center justify-between pb-4 sm:pb-6 border-b border-neutral-100 text-sm sm:text-base">
                    <div className="flex items-center gap-2 sm:gap-3 font-bold text-[#4F46E5] shrink-0 pr-2">
                      <ShieldCheck className="w-4 h-4 sm:w-5 sm:h-5" /> Global Gateway Fees
                    </div>
              ...
              <div className="mt-4 bg-[#1e293b] rounded-[20px] sm:rounded-[24px] p-4 sm:p-6 text-white flex items-start gap-3 sm:gap-4 shadow-sm">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <h4 className="font-bold text-sm sm:text-base">Global Gateway Protect</h4>
        ...
        <div className="w-full max-w-[1440px] mx-auto overflow-hidden">
          ...
          <div className="md:hidden space-y-6 sm:space-y-8 relative z-10 pl-2 max-w-md mx-auto">
            ...
            {[
              ...
              {
                step: 2,
                title: "Global Gateway thoroughly reviews everything",
        ...
        <div className="max-w-[1000px] mx-auto w-full">
          ...
          <div className="bg-[#F8F8F8] rounded-[24px] sm:rounded-[32px] md:rounded-[40px] p-4 sm:p-8 md:p-12 relative overflow-hidden border border-neutral-100">
            <div className="grid grid-cols-12 gap-2 sm:gap-4 items-center font-bold border-b border-neutral-200 pb-3 sm:pb-4 mb-3 sm:mb-4">
              ...
              <div className="col-span-3 text-center text-sm sm:text-lg md:text-xl text-neutral-900 font-extrabold">Global Gateway<span className="text-[#4F46E5]">✈</span></div>
        ...
        <div className="w-full max-w-[1440px] mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex gap-4 sm:gap-6 overflow-x-auto pb-6 sm:pb-8 hide-scrollbar snap-x px-2 sm:px-4 md:px-0">
            {[
              ...
              { init: "SA", name: "Sankathy", date: "22nd Feb 26", text: "Global Gateway has upped their game by providing backend support on call and also emergency support in case of any issues with visa documents. Have used their services for gettin...", platform: "App Store", color: "bg-blue-100 text-blue-600" },
              { init: "BP", name: "Bijoy Peter Alappattu", date: "12th Jan 26", text: "I was trying south africa visa to attend a conference. Several weeks tried through VFS and Akbar Travels and was not getting processed. Finally approached Global Gateway and the...", platform: "Trustpilot", color: "bg-green-100 text-green-600" }
            ].map((rev, i) => (
      ...
      <section className="py-14 sm:py-16 md:py-24 pb-20 sm:pb-24 md:pb-32 bg-white overflow-hidden px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-[1440px] mx-auto text-center">
          ...
          <p className="text-neutral-500 font-medium text-xs sm:text-sm md:text-base mb-8 sm:mb-12 md:mb-16">Our Global Gateway ambassadors forming government relations</p>
          ...
          <div className="flex gap-4 sm:gap-6 overflow-x-auto pb-6 sm:pb-8 hide-scrollbar snap-x px-2 sm:px-4 md:px-0 justify-start md:justify-center">
            {[
              { img: "https://images.unsplash.com/photo-1541872703-74c5e44368f9?w=600&h=800&fit=crop", name: "Achal Uppal", title: "Global Gateway Ambassador" },
            ...
            {[
              {
                ...
                a: `With Global Gateway, your visa is typically approved within 2 business days. We recommend applying at least a week before ${event.title} to account for peak event seasons.`
              },
              {
